...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("EPosDemoMvvm.Droid.Views.Sale.OrderAdapter, EPosDemoMvvm.Droid", OrderAdapter.class, __md_methods);
	}
	...
	public OrderAdapter ()
	{
		...
		if (getClass () == OrderAdapter.class) {
			mono.android.TypeManager.Activate ("EPosDemoMvvm.Droid.Views.Sale.OrderAdapter, EPosDemoMvvm.Droid", "", this, new java.lang.Object[] {  });
		}
	}
